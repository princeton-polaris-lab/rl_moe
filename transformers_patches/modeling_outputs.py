...
class MoeModelOutputWithPast(ModelOutput):
    ...
    Args:
        ...
        controller_logprobs (`torch.FloatTensor`, *optional*):
            Aggregated controller log-probabilities (e.g. switch + selection log-probs) recorded per token.
    """
    ...
    attentions: Optional[tuple[torch.FloatTensor, ...]] = None
    router_logits: Optional[tuple[torch.FloatTensor]] = None
    controller_logprobs: Optional[torch.FloatTensor] = None
